...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        glview = GLViewImpl::create("Test_box2d02");
    ...
    CCLOG("glview->getFrameSize(%.1f , %.1f)\n designResolutionSize(%.1f, %.1f)", frameSize.width, frameSize.height, designResolutionSize.width, designResolutionSize.height);
